  ...
  return (
    <div className="border-b border-amber-500/30 bg-amber-500/10">
      <div className="mx-auto flex max-w-5xl flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm font-semibold text-amber-200">Preview — not yet live</p>
        ...
        <Link
          href={ctaHref}
          className="shrink-0 rounded-md bg-amber-400 px-4 py-2 text-center text-sm font-semibold text-neutral-950 hover:bg-amber-300"
        >
