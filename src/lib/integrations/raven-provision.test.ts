...
describe('Raven provisioning signature contract', () => {
  ...
  it('validates the required Raven identity contract', () => {
    ...
    const valid = ravenProvisionSchema.parse({ version: '1', source_system: 'raven', raven_prospect_id: '00000000-0000-4000-8000-000000000001', idempotency_key: 'event-12345678', event_type: 'restaurant.provision_requested', occurred_at: '2026-09-05T12:00:00Z', google_place_id: 'ChIJ1', normalized_business_name: 'Nowhere Noodle House', normalized_address: '404 Imaginary Ave, Testburg, ZZ', normalized_website: 'https://nowhere-noodle.example.test', phone: '+19045551212', email: 'owner@nowhere-noodle.example.test', restaurant_category: 'noodles', source_payload_hash: 'a'.repeat(64), menu_source_url: 'https://nowhere-noodle.example.test/menu', menu_content: menu, menu_content_type: 'text/html', menu_content_sha256: bodyHash(menu), menu_fetched_at: '2026-09-05T12:00:00Z' });
