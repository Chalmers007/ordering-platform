...
export const pricedCartSchema = z.object({
  ...
  deliveryFeeTotalCents: cents.nonnegative().optional(),
  deliveryFeeRestaurantCents: cents.nonnegative().optional(),
  deliveryFeeCustomerCents: cents.nonnegative().optional(),
