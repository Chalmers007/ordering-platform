...
export default async function ReviewQueuePage() {
  ...
  return (
    <section>
      <div className="flex items-center justify-between"><div><h1 className="text-xl font-semibold">Restaurant setup review</h1><p className="mt-1 text-sm text-neutral-600">Claimed restaurants waiting for an operator decision.</p></div><Link href="/" className="text-sm underline">Back to overview</Link></div>
